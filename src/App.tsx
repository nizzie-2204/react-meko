      ...
      <div className="max-w-[1200px] mx-auto flex justify-between">
        ...
        <div className="w-1/2 flex flex-col space-y-10 border border-gray-300">
          <div className="h-[600px] flex items-center justify-center">
            <img
              src={require('./assets/images/product-details-1.png')}
              alt="selectedImage"
            />
          </div>
          <div className="flex items-center space-x-5 ">
            ...
            <div className="w-1/3 flex items-center justify-center border-gray-300">
              <img
                src={require('./assets/images/product-details-2.png')}
                alt="selectedImage"
                className="w-full object-cover"
              />
            </div>
            <div className="w-1/3 flex items-center justify-center border-gray-300">
              <img
                src={require('./assets/images/product-details-3.png')}
                alt="selectedImage"
                className="w-full object-cover"
              />
            </div>
        ...
        <div className="w-1/2 flex flex-col justify-center border border-gray-300">
          <div className="product-details w-full mt-10 lg:mt-0">
            ...
            <div data-aos="fade-up" className="mb-[20px] aos-init aos-animate">
